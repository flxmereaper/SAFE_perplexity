...
model_options = {
    ...
    'gpt_5': 'PERPLEXITY:gpt-5',
    'claude_4_5_sonnet': 'PERPLEXITY:claude-4.5-sonnet',
    'sonar': 'PERPLEXITY:sonar',
    'sonar_pro': 'PERPLEXITY:sonar-pro',
    'sonar_reasoning': 'PERPLEXITY:sonar-reasoning',
    'sonar_reasoning-pro': 'PERPLEXITY:sonar-reasoning-pro',
    'gemini_2_5_pro': 'PERPLEXITY:gemini-2.5-pro',
    'mistral_7b_instruct': 'PERPLEXITY:mistral-7b-instruct',
    'llama_3_1_70b_instruct': 'PERPLEXITY:llama-3.1-70b-instruct',
}
model_string = {
    ...
    'sonar': 'sonar',
    'sonar_reasoning': 'sonarreasoning',
    'sonar-reasoning-pro': 'sonarreasoningpro',
    'sonar_pro': 'sonarpro',
    'gemini_2_5_pro': 'gemini25pro',
    'mistral_7b_instruct': 'mistral7binstruct',
    'llama_3_1_70b_instruct': 'llama3170binstruct'
}
task_options = {}
root_dir = '/'.join(os.path.abspath(__file__).split('/')[:-2])
path_to_data = root_dir + '/data-for-SAFE/input'
path_to_result = root_dir + '/data-for-SAFE/output'
